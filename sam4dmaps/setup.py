...
# * name is the full name (e.g., VPlants.sam4Dmaps) whereas pkg_name is only 'sam4dmaps'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['sam4dmaps = vplants.sam4dmaps_wralea' if has_project else 'sam4dmaps = sam4dmaps_wralea' ],
        #'console_scripts': [
