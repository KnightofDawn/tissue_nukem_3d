...
Ready to contribute? Here's how to set up `openalea_nuclei_quantification` for local development.

1. Fork the `openalea_nuclei_quantification` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/openalea_nuclei_quantification.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd openalea_nuclei_quantification
    (dvlpt) openalea_nuclei_quantification$ flake8
    (dvlpt) openalea_nuclei_quantification$ nosetests
    (dvlpt) openalea_nuclei_quantification$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/moi/openalea_nuclei_quantification/pull_requests
...
.. _issues: https://github.com/moi/openalea_nuclei_quantification/issues
